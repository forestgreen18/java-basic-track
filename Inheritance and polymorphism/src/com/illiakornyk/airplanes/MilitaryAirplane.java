...
/**
 * Represents a military airplane, a specialized type of airplane designed for combat or defense purposes.
 * Inherits common attributes and behavior from the {@link Airplane} class and adds specific fields
 * for weapon type and combat radius.
 *
 * <p>This class assumes all measurements follow standard units:
 * <ul>
 *   <li>Capacity: Passengers or additional equipment (number).</li>
 ...
 *   <li>Combat radius: Maximum range in kilometers for combat missions.</li>
 * </ul>
 * </p>
 */
public class MilitaryAirplane extends Airplane {
     ...
     * @param combatRadius the maximum range the airplane can cover in a combat mission (in kilometers).
     */
    ...
    /**
     * Returns a string representation of the military airplane, including weapon type and combat radius.
     *
