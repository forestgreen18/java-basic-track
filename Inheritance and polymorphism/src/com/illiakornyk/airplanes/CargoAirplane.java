...
/**
 * Represents a cargo airplane, a specialized type of airplane designed to carry cargo. Inherits
 * common attributes and behavior from the {@link Airplane} class and adds a specific field for
 * cargo volume.
 *
 * <p>This class assumes all measurements follow standard units:
 *
 * <ul>
 *   <li>Capacity: Passengers and/or cargo space (number or cubic meters).
 ...
 *   <li>Cargo volume: Cubic meters.
 * </ul>
 */
public class CargoAirplane extends Airplane {
  private final double cargoVolume; // Cargo volume in cubic meters.
