...
/**
 * Represents a generic airplane with common attributes such as model, capacity, flight range, and fuel consumption.
 * Fuel consumption is measured in liters per kilometer.
 */
public abstract class Airplane {
    ...
    /**
     * Returns a string representation of the airplane, including its model, capacities, flight range, and fuel consumption.
     *
    ...
    public String toString() {
        return "Model: " + model + ", Capacity: " + totalCapacity + ", Carrying Capacity: " + carryingCapacity +
                ", Flight Range: " + flightRange + ", Fuel Consumption: " + fuelConsumption + " liters/km";
    }
